...
- `D:\code\work\OpenClaw\openclaw\tools\openclaw-control-ui-echarts\vendor\.gitignore`
...
- Control UI vendor files now live under `D:\code\work\OpenClaw\openclaw\tools\openclaw-control-ui-echarts\vendor` and are auto-downloaded if missing.
