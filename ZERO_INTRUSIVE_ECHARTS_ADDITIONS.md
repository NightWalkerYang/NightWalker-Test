...
- Tenant-admin statistics overview now renders `已用积分` with fixed two-decimal formatting so values such as `8` display as `8.00`, matching the rest of the monetary-style summary cards.
