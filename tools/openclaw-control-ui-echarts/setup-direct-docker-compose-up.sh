...
ECHARTS_VENDOR="$ROOT_DIR/tools/openclaw-echarts-userscript/vendor/echarts.min.js"
JSON5_VENDOR="$ROOT_DIR/tools/openclaw-echarts-userscript/vendor/json5.min.js"
...
main() {
  ...
  require_file "$ECHARTS_VENDOR" "Vendored ECharts runtime"
  require_file "$JSON5_VENDOR" "Vendored JSON5 runtime"
