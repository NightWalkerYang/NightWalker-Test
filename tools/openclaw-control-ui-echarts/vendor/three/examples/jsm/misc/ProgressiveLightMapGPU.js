import { DoubleSide, FloatType, HalfFloatType, PlaneGeometry, Mesh, RenderTarget, Scene, MeshPhongNodeMaterial, NodeMaterial } from '../../../build/three.webgpu.min.js';
import { add, float, mix, output, sub, texture, uniform, uv, vec2, vec4 } from '../../../build/three.tsl.min.js';
 ...
 *
 * @three_import import { ProgressiveLightMap } from './ProgressiveLightMapGPU.js';
 */
