import { Color, NodeMaterial } from '../../../build/three.webgpu.min.js';
import { attribute, cameraProjectionMatrix, dot, float, Fn, modelViewMatrix, modelViewProjection, normalize, positionGeometry, sign, uniform, varyingProperty, vec2, vec4 } from '../../../build/three.tsl.min.js';
 ...
 * @three_import import { LDrawConditionalLineMaterial } from './LDrawConditionalLineMaterial.js';
 */
