...
import { viewZToOrthographicDepth, reference, uniform, float, vec4, vec2, If, Fn, min, renderGroup, positionView, shadow } from '../../../build/three.tsl.min.js';
 ...
 * @three_import import { CSMShadowNode } from './CSMShadowNode.js';
 */
