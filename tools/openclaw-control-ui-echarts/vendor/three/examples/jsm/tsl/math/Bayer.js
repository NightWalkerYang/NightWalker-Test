import { ImageBitmapLoader, Texture } from '../../../../build/three.module.min.js';
import { Fn, int, ivec2, textureLoad, screenUV, screenSize, mod, floor, float, vec3 } from '../../../../build/three.tsl.min.js';

/**
 * @module Bayer
 * @three_import import { bayer16 } from './Bayer.js';
 */
