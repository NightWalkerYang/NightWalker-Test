import { NearestFilter, Vector4, TempNode, NodeUpdateType, PassNode } from '../../../../build/three.webgpu.min.js';
import { nodeObject, Fn, float, uv, uniform, convertToTexture, vec2, vec3, clamp, floor, dot, smoothstep, If, sign, step, mrt, output, normalView, property } from '../../../../build/three.tsl.min.js';
 ...
 *
 * @augments PassNode
 * @three_import import { pixelationPass } from './PixelationPassNode.js';
 */
