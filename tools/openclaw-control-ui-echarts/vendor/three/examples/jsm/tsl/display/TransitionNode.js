import { TempNode } from '../../../../build/three.webgpu.min.js';
import { nodeObject, Fn, float, uv, convertToTexture, vec4, If, int, clamp, sub, mix } from '../../../../build/three.tsl.min.js';

/**
 * Post processing node for creating a transition effect between scenes.
 *
 * @augments TempNode
 * @three_import import { transition } from './TransitionNode.js';
 */
