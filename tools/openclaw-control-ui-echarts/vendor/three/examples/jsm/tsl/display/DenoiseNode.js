import { DataTexture, RepeatWrapping, Vector2, Vector3, TempNode } from '../../../../build/three.webgpu.min.js';
import { texture, getNormalFromDepth, getViewPosition, convertToTexture, nodeObject, Fn, float, NodeUpdateType, uv, uniform, Loop, luminance, vec2, vec3, vec4, uniformArray, int, dot, max, pow, abs, If, textureSize, sin, cos, mat2, PI, property } from '../../../../build/three.tsl.min.js';
 ...
 *
 * @augments TempNode
 * @three_import import { denoise } from './DenoiseNode.js';
 */
