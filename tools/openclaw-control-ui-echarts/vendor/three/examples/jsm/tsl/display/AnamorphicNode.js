import { RenderTarget, Vector2, TempNode, QuadMesh, NodeMaterial, RendererUtils } from '../../../../build/three.webgpu.min.js';
import { nodeObject, Fn, float, NodeUpdateType, uv, passTexture, uniform, convertToTexture, vec2, vec3, Loop, mix, luminance } from '../../../../build/three.tsl.min.js';
 ...
 *
 * @augments TempNode
 * @three_import import { anamorphic } from './AnamorphicNode.js';
 */
