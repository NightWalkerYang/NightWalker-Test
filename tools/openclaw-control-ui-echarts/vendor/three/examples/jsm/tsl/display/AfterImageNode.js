import { RenderTarget, Vector2, QuadMesh, NodeMaterial, RendererUtils, TempNode, NodeUpdateType } from '../../../../build/three.webgpu.min.js';
import { nodeObject, Fn, float, uv, texture, passTexture, sign, max, convertToTexture } from '../../../../build/three.tsl.min.js';
 ...
 *
 * @augments TempNode
 * @three_import import { afterImage } from './AfterImageNode.js';
 */
