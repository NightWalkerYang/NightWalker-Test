...
import { Fn, float, vec3, vec4, ivec2, int, uv, floor, abs, max, min, exp2, nodeObject, passTexture, textureSize, textureLoad, convertToTexture } from '../../../../build/three.tsl.min.js';
 ...
 *
 * @augments TempNode
 * @three_import import { sharpen } from './SharpenNode.js';
 */
