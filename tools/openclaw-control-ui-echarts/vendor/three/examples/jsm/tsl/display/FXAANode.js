import { Vector2, TempNode } from '../../../../build/three.webgpu.min.js';
import { Fn, uniformArray, select, float, NodeUpdateType, uv, dot, clamp, uniform, convertToTexture, smoothstep, bool, vec2, vec3, If, Loop, max, min, Break, abs } from '../../../../build/three.tsl.min.js';
 ...
 *
 * @augments TempNode
 * @three_import import { fxaa } from './FXAANode.js';
 */
