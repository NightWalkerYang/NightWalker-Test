import { HalfFloatType, RenderTarget, Vector2, Vector3, TempNode, QuadMesh, NodeMaterial, RendererUtils, NodeUpdateType } from '../../../../build/three.webgpu.min.js';
import { nodeObject, Fn, float, uv, passTexture, uniform, Loop, texture, luminance, smoothstep, mix, vec4, uniformArray, add, int } from '../../../../build/three.tsl.min.js';
 ...
 * ```
 * @augments TempNode
 * @three_import import { bloom } from './BloomNode.js';
 */
