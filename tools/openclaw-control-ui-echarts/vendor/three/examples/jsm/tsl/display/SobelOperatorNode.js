import { Vector2, TempNode, NodeUpdateType } from '../../../../build/three.webgpu.min.js';
import { Fn, uv, uniform, convertToTexture, vec2, vec3, vec4, mat3, luminance, add } from '../../../../build/three.tsl.min.js';
 ...
 *
 * @augments TempNode
 * @three_import import { sobel } from './SobelOperatorNode.js';
 */
