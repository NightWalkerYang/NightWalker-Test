import { AdditiveBlending, Color, Vector2, RendererUtils, PassNode, QuadMesh, NodeMaterial } from '../../../../build/three.webgpu.min.js';
import { uniform, mrt, texture, getTextureIndex, unpremultiplyAlpha } from '../../../../build/three.tsl.min.js';
 ...
 *
 * @augments PassNode
 * @three_import import { ssaaPass } from './SSAAPassNode.js';
 */
