import { RenderTarget, Vector2, NodeMaterial, RendererUtils, QuadMesh, TempNode, NodeUpdateType } from '../../../../build/three.webgpu.min.js';
import { Fn, float, uv, uniform, convertToTexture, vec2, vec4, passTexture, premultiplyAlpha, unpremultiplyAlpha } from '../../../../build/three.tsl.min.js';
 ...
 *
 * @augments TempNode
 * @three_import import { gaussianBlur, premultipliedGaussianBlur } from './GaussianBlurNode.js';
 */
