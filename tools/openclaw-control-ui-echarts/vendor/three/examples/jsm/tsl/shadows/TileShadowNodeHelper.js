import { Group, NodeMaterial, Mesh, PlaneGeometry, DoubleSide, CameraHelper } from '../../../../build/three.webgpu.min.js';
import { Fn, vec4, vec3, texture, uv, positionLocal, vec2, float, screenSize } from '../../../../build/three.tsl.min.js';

/**
 * Helper class to manage and display debug visuals for TileShadowNode.
 *
 * @augments Group
 * @three_import import { TileShadowNodeHelper } from './TileShadowNodeHelper.js';
 */
