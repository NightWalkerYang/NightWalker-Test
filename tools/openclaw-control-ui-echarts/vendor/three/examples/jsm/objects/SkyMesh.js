import {
	...
	Vector3,
	NodeMaterial
} from '../../../build/three.webgpu.min.js';

import { Fn, float, vec2, vec3, acos, add, mul, clamp, cos, dot, exp, max, mix, modelViewProjection, normalize, positionWorld, pow, smoothstep, sub, varyingProperty, vec4, uniform, cameraPosition, fract, floor, sin, time, Loop, If } from '../../../build/three.tsl.min.js';
 ...
 *
 * @augments Mesh
 * @three_import import { SkyMesh } from './SkyMesh.js';
 */
