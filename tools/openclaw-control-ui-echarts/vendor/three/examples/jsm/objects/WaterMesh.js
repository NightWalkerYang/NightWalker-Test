...
import { Fn, add, cameraPosition, div, normalize, positionWorld, sub, time, texture, vec2, max, dot, reflect, pow, length, float, uniform, reflector, mul, mix } from '../../../build/three.tsl.min.js';
 ...
 *
 * @augments Mesh
 * @three_import import { WaterMesh } from './WaterMesh.js';
 */
