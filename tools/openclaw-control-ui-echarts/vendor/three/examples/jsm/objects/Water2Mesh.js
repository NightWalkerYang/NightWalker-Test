...
import { Fn, vec2, viewportSafeUV, viewportSharedTexture, reflector, pow, float, abs, texture, uniform, vec4, cameraPosition, positionWorld, uv, mix, vec3, normalize, max, dot, screenUV } from '../../../build/three.tsl.min.js';
 ...
 *
 * @augments Mesh
 * @three_import import { WaterMesh } from './Water2Mesh.js';
 */
