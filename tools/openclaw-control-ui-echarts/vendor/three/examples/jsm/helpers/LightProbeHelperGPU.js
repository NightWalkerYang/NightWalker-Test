...
import { float, Fn, getShIrradianceAt, normalWorld, uniformArray, uniform, vec4 } from '../../../build/three.tsl.min.js';
 ...
 * @private
 * @augments Mesh
 * @three_import import { LightProbeHelper } from './LightProbeHelperGPU.js';
 */
