...
const SHARED_VENDOR_DIR = path.join(
  repoRoot,
  "tools",
...
function main() {
  ...
  ensureFileExists(path.join(SHARED_VENDOR_DIR, "echarts.min.js"), "Vendored ECharts runtime");
  ensureFileExists(path.join(SHARED_VENDOR_DIR, "json5.min.js"), "Vendored JSON5 runtime");
  ...
  copyFileIntoOutput(
    path.join(SHARED_VENDOR_DIR, "echarts.min.js"),
    path.join(outputDir, "assets", "vendor", "echarts.min.js"),
  );
  copyFileIntoOutput(
    path.join(SHARED_VENDOR_DIR, "json5.min.js"),
